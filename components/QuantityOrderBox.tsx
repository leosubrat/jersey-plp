  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-soft md:p-8">
      <div className="mb-5 flex items-start justify-between gap-5 max-sm:flex-col">
        ...
        <div className="rounded-md bg-barca-gold/20 px-3.5 py-2.5 text-xs font-black leading-5 text-slate-900 shadow-sm">Free FC Barcelona Club banner included</div>
      </div>
      ...
      <div className="mb-6 rounded-md border border-slate-200 bg-slate-50 p-4 text-sm leading-7 text-slate-700">
        Full Cash on Delivery is available. Place your order now and pay the full amount when your jersey is delivered.
      </div>
