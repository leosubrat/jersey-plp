...
export function ProductGallery() {
  ...
  return (
    <div className="w-full max-w-full space-y-5 lg:max-w-[540px]">
      <div className="group relative overflow-hidden rounded-lg border border-slate-200 bg-white shadow-[0_22px_70px_rgba(15,23,42,0.12)] transition duration-300 hover:shadow-[0_28px_90px_rgba(15,23,42,0.16)]">
        ...
        <button
          ...
          onClick={previous}
          className="focus-ring absolute left-3 top-1/2 grid h-10 w-10 -translate-y-1/2 place-items-center rounded-full bg-white/90 text-slate-900 shadow-sm"
        >
        ...
        <button
          ...
          onClick={next}
          className="focus-ring absolute right-3 top-1/2 grid h-10 w-10 -translate-y-1/2 place-items-center rounded-full bg-white/90 text-slate-900 shadow-sm"
        >
        ...
        {product.images.map((image, index) => (
          <button
            ...
            className={`focus-ring group relative aspect-square overflow-hidden rounded-md border bg-white shadow-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-md ${
              active === index ? "border-barca-blue ring-2 ring-barca-blue/70" : "border-slate-200"
            }`}
          >
